...
- `npm run icons:pwa`: `src/config/brand.json` → `public/<logoFilename>` → PWA + `src/app/icon.png` + `favicon.ico`.
...
- `public/icons/apple-touch-icon.png` — Apple Touch Icon (180×180 PNG, `icons:pwa` ile).
