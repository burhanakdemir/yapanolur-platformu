...
import AdminGateLoginLayout from "./admin-gate-login-layout";
...
export default async function AdminPage() {
  ...
  if (!ok) {
    ...
    let initialMfa: { email: string; needsEnrollment: boolean } | null = null;
    if (pending) {
      ...
      if (row) {
        initialMfa = { email: row.email, needsEnrollment: !row.adminTotpSecretEnc };
      }
    }
    ...
    return <AdminGateLoginLayout initialMfa={initialMfa} devHints={devHints} />;
  }
